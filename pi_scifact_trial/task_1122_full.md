You are in a working directory containing corpus.jsonl, a JSONL file with 500,000 scientific paper records (fields: doc_id, title, abstract as a list of sentences). This is a large read-only reference dataset — do not modify, sort, rewrite, or delete it; only read/search it.
